...
import { selectCart, selectAuth, selectUser } from "../../selectors/appSelectors";
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link
              to="/cart"
              className="relative inline-flex items-center text-gray-600 hover:text-gray-800"
            >
              <svg
        ...
        {/* Mobile Menu */}
        <div data-testid="mobile-menu" className={`${isMenuOpen ? "block" : "hidden"} md:hidden pb-4`}>
          <div className="flex flex-col space-y-4">
            ...
            >
              <span>Cart</span>
              {cart.items.length > 0 && (
                <span data-testid="cart-count" className="bg-gray-800 text-white px-2 py-1 rounded-full text-xs">
                  {cart.items.length}
                </span>
              )}
            </Link>
